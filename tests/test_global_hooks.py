...
def test_activate_in_ipython_by_import_error(tmp_path):
    ...
    assert_smart_equals_ref('test_override.activate_in_ipython_by_import_error'
                            '', run_code(tmp_path, [], code, [], True))


def test_activate_ipython_by_import_win32(tmp_path):
    _test_activate_in_ipython_by_import(tmp_path, 'test_override.activate_in_ipython_by_import_win32', True)


def test_activate_ipython_by_import_no_win32(tmp_path):
    _test_activate_in_ipython_by_import(tmp_path, 'test_override.activate_in_ipython_by_import_no_win32', False)
